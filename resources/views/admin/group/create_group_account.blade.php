    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="card card-outline card-primary">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form data-parsley-validate="" method="post" action="{{route('create_group_account')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Select B.O Ids</label>
                      <select class="select2 select2-hidden-accessible bo_ids" name="bo_ids[]" multiple="multiple" ata-placeholder="Select a State" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true">
                        <option class="form-control" value="">-- Select B.O Account --</option>
                        @foreach($get_data as $val)
                          <option class="form-control" value="{{ $val->bo_identification_number }}">
                          {{ $val->name_of_first_holder }} ({{ $val->bo_identification_number }})
                          </option>
                        @endforeach
                      </select>
              ...
              <div class="card-footer">
                ...
                <a href="{{route('manage_group_account')}}" class="btn btn-default">Cancel</a>
              </div>
            </form>
          </div>
        </div>
