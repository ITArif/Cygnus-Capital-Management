        ...
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
            <table id="all-circuit-data" class="table table-bordered table-striped">
              ...
              <tbody>
                @foreach($dse_data as $dse)
                  <tr>
                    <td>{{ $dse->range_start }} - {{ $dse->range_end }}</td>
                      <td>{{ $dse->breaker_value }} %</td>
                    <td>
                      <a data-id="{{ $dse->id }}" data-range-start="{{ $dse->range_start }}" data-range-end="{{ $dse->range_end }}" data-breaker-value="{{ $dse->breaker_value }}" href="#" class="edit-circuit-breaker btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>

                      <button id="{{$dse->id}}" class="btn btn-danger btn-xs deleteCircuitBrekerData"><i class="far fa-trash-alt"></i></button>
                    </td>
                  </tr>
                @endforeach
             </tbody>
...
<script>
 ...
 $(".open_circuit_breker_modal").on("click", function(e) {
    ...
    $("#save-circuit").on("click", function(e) {
      ...
      var url_data = "{{ url('circuit_breaker_data') }}";
    ...
    $(".deleteCircuitBrekerData").click(function () {
      var id=$(this).attr('id');
      //alert(id);
      var url="{{url('delete_circuit_breaker_data')}}";
      $.ajax({
          url:url+"/"+id,
          type:"GET",
          dataType:"json",
